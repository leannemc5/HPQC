...
int generate_timestamps(double* time_stamps, int time_steps, double ste_size);
...
// declare and initialise the numerical argument variable
  ...
  // creates variables for the vibration
    int cycles = 50; // number of cycles to show
...
// creates file
    FILE* out_file = fopen("HPQC/week5/string_wave_damping.csv","w");
